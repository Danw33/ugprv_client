...
namespace ugprv_ui_elements
{
    public class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Maquette_Avion);
