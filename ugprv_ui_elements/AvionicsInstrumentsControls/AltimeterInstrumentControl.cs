...
namespace ugprv_ui_elements
{
    public class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(ugprv_ui_elements.AvionicsInstrumentsControls.AvionicsInstrumentsControlsRessources.Bandeau_Dérouleur);
