    ...
    : IDisposable
  {
    ...
    private static LibraryHandle GetOrLoadLibrary(string libVLCDirectory)
    {
      ...
      lock(m_LibraryHandles)
      {
        ...
        Debug.Write("Running with Current Directory: ", "LibVLC");
        ...
        string program_files64_path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFiles), "VideoLAN", "VLC");
